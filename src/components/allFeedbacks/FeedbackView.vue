<template>
    <div class="h-full flex justify-center items-center">
        <div v-if="feedback" class="w-full max-w-2xl mt-10 m-auto p-4 flex">
            <div class="mt-6 mr-2">
            ...
            <div class="grow">
                ...
                <p class="font-normal text-[16px] text-slate-800 mt-5 whitespace-pre-wrap"> {{  feedback.message }}</p>
            </div>
        </div>
    </div>
</template>
